...
// Determine the current season (you'll need to implement this logic)
...
if ($currentMonth >= 12 || $currentMonth <= 2) {
    ...
    $currentSeason = 'winter'; // Default to winter if the month is not within 1-12
}

$sql = "SELECT * FROM package ORDER BY CASE
            WHEN season = '$currentSeason' THEN 0
            ELSE 1
        END, packageName";
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4"><?php if(isset($_SESSION['sesLoginDetails'])) echo $_SESSION['sesLoginDetails']['fullName']; else echo "Traveler" ?></h1>
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Price Cuts Galore! Travel More, Save More! Unwrap Incredible Adventure Here! Get More for Less!</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">“We’re not satisfied until you are”</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">“Once a year, go someplace you've never been before”</p>
                        </div>
                    </div>
                </div>
            </div>
...
<table cellpadding='20'><tr>
    ...
    box-sizing: border-box;">
            <img  class="" src="<?php echo $row['image'] ?>" height="235px" width="350px">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-map-marker-alt text-primary mr-2"></i><?php echo $row['packageName'];?></small>
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i><?php echo $row['numberOfDays'];?>Days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i><?php echo $row['packageLocation'];?></small>     
                            </div> 
                            <a class="h5 text-decoration-none" href="" style="display: block;width: 300px; height: 50px;"><?php echo $row['packageDetail'];?></a> 
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between mb-3">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0"><?php echo $row['price']; ?>Rs/- </h5>
                                </div>
                            </div>               
                        </div>
                        <?php 
                        ...
                        {
                            echo '<a class="btn btn-primary btn-block py-3" type="submit" name="btnSubmit" href="book.php">Book Now</a>';
