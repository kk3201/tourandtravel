...
if (isset($_POST['btnsubmit'])) {
    ...
    $sql = "INSERT INTO review(customerId,Subject,Message,email) VALUES('$id','$subject','$message','$email')";
    if(mysqli_query($conn, $sql)){
        echo "<script>alert('Your review is submitted');window.location.href='Homepage.php'</script>";
    }
    else
        echo "<script>alert('Your review is not submitted');window.location.href='Homepage.php'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
