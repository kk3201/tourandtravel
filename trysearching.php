            ...
            <img class="img-fluid" src="img/package-1.jpg" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <small class="m-0"><i class="fa fa-calendar-alt text-primary mr-2"></i><?php echo $row['NoDays'];?>Days</small>
                                <small class="m-0"><i class="fa fa-user text-primary mr-2"></i><?php echo $row['PackageLocation'];?></small>     
                            </div>                        
                            <a class="h5 text-decoration-none" href=""><?php echo $row['PackageDetails'];?></a>
                            <div class="border-top mt-4 pt-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="m-0"><i class="fa fa-star text-primary mr-2"></i>4.5 <small>(250)</small></h6>
                                    <h5 class="m-0"><?php echo $row['PackagePrice']; ?>Rs/- </h5>
                                </div>
                            </div>               
                        </div>
